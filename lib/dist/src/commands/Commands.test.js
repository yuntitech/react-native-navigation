...
describe('Commands', () => {
    ...
    describe('setRoot', () => {
        ...
        it('retains passProps properties identity', () => {
            ...
            const args = ts_mockito_1.capture(mockedStore.setPendingProps).last();
    ...
    describe('dismissModal', () => {
        ...
        it('processes mergeOptions', async () => {
            ...
            ts_mockito_1.verify(mockedOptionsProcessor.processOptions(CommandName_1.CommandName.DismissModal, options)).called();
        });
    });
    describe('dismissAllModals', () => {
        ...
        it('processes mergeOptions', async () => {
            ...
            ts_mockito_1.verify(mockedOptionsProcessor.processOptions(CommandName_1.CommandName.DismissAllModals, options)).called();
        });
    });
    describe('push', () => {
    ...
    describe('pop', () => {
        ...
        it('processes mergeOptions', async () => {
            ...
            uut.pop('theComponentId', options);
            ts_mockito_1.verify(mockedOptionsProcessor.processOptions(CommandName_1.CommandName.Pop, options)).called();
        });
    });
    describe('popTo', () => {
        ...
        it('processes mergeOptions', async () => {
            ...
            ts_mockito_1.verify(mockedOptionsProcessor.processOptions(CommandName_1.CommandName.PopTo, options)).called();
        });
    });
    describe('popToRoot', () => {
        ...
        it('processes mergeOptions', async () => {
            ...
            ts_mockito_1.verify(mockedOptionsProcessor.processOptions(CommandName_1.CommandName.PopToRoot, options)).called();
        });
    });
