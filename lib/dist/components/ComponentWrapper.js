    ...
    wrap(componentName, OriginalComponentGenerator, store, componentEventsObserver, concreteComponentProvider = OriginalComponentGenerator, ReduxProvider, reduxStore, floatingView) {
        ...
        class WrappedComponent extends React.Component {
            ...
            render() {
              ...
              <AudioPlayFloatingViewClass screenID={componentName} componentId={this.state.componentId} customTitleBar={this.state.allProps.enableCustomLargeTitle} bottomTabVisible={this.state.allProps.bottomTabVisible}/>
