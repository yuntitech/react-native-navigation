...
RCT_EXPORT_METHOD(mergeOptions
                  : (NSString *)componentId options
                  : (NSDictionary *)options resolver
                  : (RCTPromiseResolveBlock)resolve rejecter
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler mergeOptions:componentId
                                   options:options
                                completion:^{
                                  resolve(componentId);
                                }];
...
RCT_EXPORT_METHOD(setDefaultOptions
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler setDefaultOptions:options
                                     completion:^{
                                       resolve(nil);
                                     }];
    });
...
RCT_EXPORT_METHOD(push
                  ...
                  : (NSString *)componentId layout
                  : (NSDictionary *)layout resolver
                  : (RCTPromiseResolveBlock)resolve rejecter
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler push:componentId
                         commandId:commandId
                            layout:layout
...
RCT_EXPORT_METHOD(pop
                  : (NSString *)commandId componentId
                  : (NSString *)componentId mergeOptions
                  : (NSDictionary *)options resolver
                  : (RCTPromiseResolveBlock)resolve rejecter
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler pop:componentId
                        commandId:commandId
...
RCT_EXPORT_METHOD(setStackRoot
                  : (NSString *)commandId componentId
                  : (NSString *)componentId children
                  : (NSArray *)children resolver
                  : (RCTPromiseResolveBlock)resolve rejecter
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler setStackRoot:componentId
                                 commandId:commandId
                                  children:children
                                completion:^{
                                  resolve(componentId);
...
RCT_EXPORT_METHOD(popTo
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler popTo:componentId
                          commandId:commandId
...
RCT_EXPORT_METHOD(popToRoot
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler popToRoot:componentId
                              commandId:commandId
                           mergeOptions:options
                             completion:^{
                               resolve(componentId);
...
RCT_EXPORT_METHOD(showModal
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler showModal:layout
                              commandId:commandId
                             completion:^(NSString *componentId) {
                               resolve(componentId);
                             }];
...
RCT_EXPORT_METHOD(dismissModal
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler dismissModal:componentId
                                 commandId:commandId
                              mergeOptions:options
                                completion:^(NSString *componentId) {
                                  resolve(componentId);
...
RCT_EXPORT_METHOD(dismissAllModals
                  : (NSString *)commandId mergeOptions
                  : (NSDictionary *)options resolver
                  : (RCTPromiseResolveBlock)resolve rejecter
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler dismissAllModals:options
                                     commandId:commandId
                                    completion:^{
                                      resolve(nil);
                                    }];
...
RCT_EXPORT_METHOD(showOverlay
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler showOverlay:layout
                                commandId:commandId
...
RCT_EXPORT_METHOD(dismissOverlay
                  ...
                  : (RCTPromiseRejectBlock)reject) {
    RCTExecuteOnMainQueue(^{
      [self->_commandsHandler dismissOverlay:componentId
                                   commandId:commandId
                                  completion:^{
                                    resolve(@(1));
                                  }
