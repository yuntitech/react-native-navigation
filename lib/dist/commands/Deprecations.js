...
class Deprecations {
    ...
    deprecateSearchBarOptions = once_1.default((parentOptions) => {
    ...
    deprecateInterpolationOptions = once_1.default((parentOptions) => {
    ...
    deprecateBottomTabsVisibility = once_1.default((parentOptions) => {
