...
describe('navigation options', () => {
    ...
    describe('color processor', () => {
        ...
        describe('iOS', () => {
            ...
            it('supports DynamicColorIOS', () => {
                const options = {
                    topBar: { background: { color: react_native_1.DynamicColorIOS({ light: 'red', dark: 'blue' }) } },
                };
                uut.processOptions(CommandName_1.CommandName.SetRoot, options);
                expect(options).toEqual({
    ...
    it('calls store if component has passProps', () => {
        ...
        uut.processOptions(CommandName_1.CommandName.SetRoot, options);
        ts_mockito_1.verify(mockedStore.setPendingProps('CustomComponent1', passProps)).called();
    });
    ...
    it('calls store when button has passProps and id', () => {
        ...
        uut.processOptions(CommandName_1.CommandName.SetRoot, options);
        ts_mockito_1.verify(mockedStore.setPendingProps('1', passProps)).called();
    });
